...
# Teste versões beta!
Para testar a última versão beta da ICP, simplesmente copie as seguintes linhas no console de desenvolvedor do seu navegador quando a ICP estiver aberta ou, se preferir, copie em seu JavaScript pessoal: 
```javascript
importScriptURI("https://cdn.rawgit.com/brosquinha/ICP/master/ICP.js");
importStylesheetURI("https://cdn.rawgit.com/brosquinha/ICP/master/Wikia.css");
```
